    ...
    class Variable_Solved
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            //initialization 
            firstExample = 1; //once it is declared you refer to it by name only. DO NOT put the data type. C# would think you are trying to make a new container.
            ...
            name = "Harry Potter"; //assignment, also called reassignment
            ...
            //Console.WriteLine(occupation); this will not work because occupation is not initialized
            ...
            const int CURRENT_YEAR = 2022; //note the UPPERCASE naming convention
            //currentYear = 2023; this will not work
            ...
            int bigNbr = 55321; //dont use commas for big nums
            Console.WriteLine(bigNbr);
            Console.WriteLine(55321);
            Console.WriteLine("55321");
            //All of these look the same in the console. However, I could call on bigNum and use that value over and over. I do not have a way to call on 55321 and "55321"
            //and use it again. 
            ...
            Console.WriteLine("17" + "25"); //adding two strings together is called concatenation. All this does is combine the two strings together. No calculation.
            ...
            //The() around the numeric calculation trumps the order of operations and makes sure the concatenation happens AFTER the calculation.
